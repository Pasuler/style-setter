                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12 d-flex align-items-center">
                            <div class="card-body px-5">
                                <h3 class="card-title text-center my-4"><strong>Login</strong></h3>
                                ...
                                <form action="aksi_login.php?op=in" method="post">
                                    ...
                                    <div class="d-grid gap-2">
                                        <button type="submit" name="login" class="btn rounded-3 mt-4 text-white" style="background-color: #81c4fc;"><strong>Login</strong></button>
                                    </div>
                                </form>
                                <div class="mt-4 text-center mb-4">
                                    <p>Don't have an account? <a href="../admin/register.php" class="fw-bold text-dark"> Register</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
